...
FREEZE_SOUND_PATHS = [
    "Sounds And Music/ice-freeze-1.ogg",
    "Sounds And Music/ice-freeze-2.ogg",
    "Sounds And Music/ice-freeze-3.ogg",
]
...
font = pygame.font.Font(r"Assets/fonts/LowresPixel-Regular.otf", 28)
big_font = pygame.font.Font(r"Assets/fonts/LowresPixel-Regular.otf", 56)
...
enemy_frozen_img = pygame.image.load(r"Assets/Enemies/01_pixilart-sprite (14).png").convert_alpha()
enemy_frozen_img_2 = pygame.image.load(r"Assets/Enemies/pixil-frame-0.png").convert_alpha()
